...
// add an event
window.addEventListener("scroll", navHlighter);
function navHlighter()
{
  // get current scroll
...
const filterContainer = document.querySelector(".protfolio-filter-inner"),
      ...
      protfolioItems = document.querySelectorAll(".protfulio-item"),
      totalPortfolioItem = protfolioItems.length;
      ...
      for(let i=0; i<totalFilterBtn; i++)
      {
        filterBtns[i].addEventListener("click", function()
        {
          ...
          {
            if(filterValue === protfolioItems[k].getAttribute("data-categary"))
            {
